...
Student: Mohammad Almadani

---

📖 Overview
This repository contains the submission portfolio for the ARTI 308 Machine Learning course. It documents the weekly graded lab assignments, focusing on practical ML workflows ranging from data preprocessing and exploratory analysis to model training and evaluation.

📂 Lab Progress Tracker
The curriculum includes 12 labs, with 9 graded assignments.
